...
public class StoreDaoTest {
    ...
    public void testSelectById(TestInfo testInfo) throws Exception {
        SqlFile sqlFile = repository.getSqlFile(testInfo.getTestMethod().get(), "META-INF/com/example/demo/doma/generator/dao/StoreDao/selectById.sql", dialect);
        execute(sqlFile);
    }
    ...
    public void testSelectByIdAndVersion(TestInfo testInfo) throws Exception {
        SqlFile sqlFile = repository.getSqlFile(testInfo.getTestMethod().get(), "META-INF/com/example/demo/doma/generator/dao/StoreDao/selectByIdAndVersion.sql", dialect);
        execute(sqlFile);
    }
