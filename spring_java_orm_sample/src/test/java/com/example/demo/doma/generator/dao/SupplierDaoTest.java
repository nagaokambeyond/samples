...
public class SupplierDaoTest {
    ...
    public void testSelectById(TestInfo testInfo) throws Exception {
        SqlFile sqlFile = repository.getSqlFile(testInfo.getTestMethod().get(), "META-INF/com/example/demo/doma/generator/dao/SupplierDao/selectById.sql", dialect);
        execute(sqlFile);
    }
    ...
    public void testSelectByIdAndVersion(TestInfo testInfo) throws Exception {
        SqlFile sqlFile = repository.getSqlFile(testInfo.getTestMethod().get(), "META-INF/com/example/demo/doma/generator/dao/SupplierDao/selectByIdAndVersion.sql", dialect);
        execute(sqlFile);
    }
