...
public class BookDaoTest {
    ...
    public void testSelectById(TestInfo testInfo) throws Exception {
        SqlFile sqlFile = repository.getSqlFile(testInfo.getTestMethod().get(), "META-INF/com/example/demo/doma/generator/dao/BookDao/selectById.sql", dialect);
        execute(sqlFile);
    }
    ...
    public void testSelectByIdAndVersion(TestInfo testInfo) throws Exception {
        SqlFile sqlFile = repository.getSqlFile(testInfo.getTestMethod().get(), "META-INF/com/example/demo/doma/generator/dao/BookDao/selectByIdAndVersion.sql", dialect);
        execute(sqlFile);
    }
