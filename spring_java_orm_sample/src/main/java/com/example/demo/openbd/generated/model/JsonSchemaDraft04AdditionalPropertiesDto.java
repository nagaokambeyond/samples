...
public class JsonSchemaDraft04AdditionalPropertiesDto extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(JsonSchemaDraft04AdditionalPropertiesDto.class.getName());

    public static class JsonSchemaDraft04AdditionalPropertiesDtoSerializer extends StdSerializer<JsonSchemaDraft04AdditionalPropertiesDto> {
        public JsonSchemaDraft04AdditionalPropertiesDtoSerializer(Class<JsonSchemaDraft04AdditionalPropertiesDto> t) {
            super(t);
        }

        public JsonSchemaDraft04AdditionalPropertiesDtoSerializer() {
            this(null);
        }

        @Override
        public void serialize(JsonSchemaDraft04AdditionalPropertiesDto value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class JsonSchemaDraft04AdditionalPropertiesDtoDeserializer extends StdDeserializer<JsonSchemaDraft04AdditionalPropertiesDto> {
        public JsonSchemaDraft04AdditionalPropertiesDtoDeserializer() {
            this(JsonSchemaDraft04AdditionalPropertiesDto.class);
        }

        public JsonSchemaDraft04AdditionalPropertiesDtoDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public JsonSchemaDraft04AdditionalPropertiesDto deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            if (match == 1) {
                JsonSchemaDraft04AdditionalPropertiesDto ret = new JsonSchemaDraft04AdditionalPropertiesDto();
                ret.setActualInstance(deserialized);
                return ret;
            }
            throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for JsonSchemaDraft04AdditionalPropertiesDto: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public JsonSchemaDraft04AdditionalPropertiesDto getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "JsonSchemaDraft04AdditionalPropertiesDto cannot be null");
        }
    }
    ...
    public JsonSchemaDraft04AdditionalPropertiesDto() {
        super("oneOf", Boolean.FALSE);
    }

    public JsonSchemaDraft04AdditionalPropertiesDto(Boolean o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public JsonSchemaDraft04AdditionalPropertiesDto(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        JSON.registerDescendants(JsonSchemaDraft04AdditionalPropertiesDto.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, Class<?>> getSchemas() {
        return JsonSchemaDraft04AdditionalPropertiesDto.schemas;
    }
