...
public class BookStock {
    @Id
    @SequenceGenerator(name = "book_stock_seq_generator", sequenceName = "book_stock_seq", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "book_stock_seq_generator")
    private Long id;
