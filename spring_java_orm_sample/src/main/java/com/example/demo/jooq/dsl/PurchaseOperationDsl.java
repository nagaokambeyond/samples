...
public class PurchaseOperationDsl {
    ...
    public void addStockQuantity(Long storeId, PurchaseInvoiceDetailRow detail, LocalDateTime now) {
    ...
    private Record3<Long, Integer, Long> selectBookStockForUpdate(Long storeId, Long bookId) {
