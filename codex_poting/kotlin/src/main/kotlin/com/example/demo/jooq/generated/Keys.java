...
public class Keys {
    ...
    public static final ForeignKey<BookStockRecord, BookRecord> CONSTRAINT_9D4E = Internal.createForeignKey(BookStock.BOOK_STOCK, DSL.name("CONSTRAINT_9D4E"), new TableField[] { BookStock.BOOK_STOCK.BOOK_STOCK_BOOK_ID }, Keys.CONSTRAINT_2, new TableField[] { Book.BOOK.ID }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
