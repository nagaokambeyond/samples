...
interface PurchaseOperationApi {
    @PostMapping("/create")
    ...
    @ApiResponses(
        ApiResponse(
            responseCode = "200",
            description = "成功",
            content = [Content(mediaType = "application/json", schema = Schema(implementation = PurchaseInvoiceResponse::class))]
        ),
        ApiResponse(
            responseCode = "400",
    ...
    fun createPurchaseInvoice(
        @RequestBody @Valid @NotNull request: PurchaseInvoiceCreateRequest
