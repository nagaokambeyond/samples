...
interface BooksOperationApi {
    ...
    fun getBook(
        @Parameter(description = "本ID") @PathVariable id: Long
    ...
    @ApiResponses(
        ApiResponse(
            responseCode = "200",
            description = "成功",
            content = [Content(mediaType = "application/json", schema = Schema(implementation = BookPageResponse::class))]
        ),
        ApiResponse(
            responseCode = "400",
            description = "リクエストエラー",
    ...
    fun createBook(
        @RequestBody @Valid @NotNull request: BookCreateRequest
    ): BookResponse
    ...
    fun updateBook(
        @RequestBody @Valid @NotNull request: BookUpdateRequest
    ): BookResponse
